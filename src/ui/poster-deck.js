...
(function () {
  /** Renders up to five films as a compact layered deck. @param {FilmRecord[]} films Poster source films. @param {{classes?: string, limit?: number}} [options] Presentation options. @returns {string} Poster deck HTML. */
